...
def execute_query(user, visualization):
    if visualization.query:
        job = Job(query=visualization.query, start_at=timezone.now(), query_checksum=visualization.query.checksum, created_by=user)
